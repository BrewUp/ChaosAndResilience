...
public sealed class WithdrawlFromWarehouseForSalesOrderEventHandler(IQueries<Availability> queries,
	ILoggerFactory loggerFactory,
	IServiceBus serviceBus,
	IMessagesService messagesService) : IntegrationEventHandlerAsync<WithdrawlFromWarehouseForSalesOrder>(loggerFactory)
{
	public override async Task HandleAsync(WithdrawlFromWarehouseForSalesOrder @event,
